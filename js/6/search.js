...
function liveSearchHide() {
  ...
  var hid = document.getElementById("LSHide");
  hid.style.display = "block";    
  
  //div_input = document.getElementById(liveSearchIdInput);
  //div_input.value = "";
...
function liveSearchDoSearch() {
  ...
  if (liveSearchLast != div_input.value) {
  ...
  liveSearchReq.open("GET", liveSearchRoot + "/" + liveSearchFile + "?"+liveSearchParams+"&q=" + div_input.value + liveSearchParams2);
  liveSearchLast = div_input.value;
